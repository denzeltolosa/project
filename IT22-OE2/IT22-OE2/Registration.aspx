                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td class="auto-style3">
                     ...
                     <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label6" runat="server" Text="Balance" Font-Bold="True" Font-Size="Large"></asp:Label>
                    </td>
                    <td class="auto-style3">
                        <asp:TextBox ID="txtBalance" runat="server" Width="240px" Height="20px"></asp:TextBox>
                    </td>
                           <tr>
                     <tr>
                    <td class="auto-style1">
